...
# Build the binary (custom builds keep upstream update checks but disable in-place updates)
...
LABEL org.opencontainers.image.source="https://github.com/langchou/sub2api"
